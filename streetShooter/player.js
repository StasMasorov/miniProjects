const MOVE_UP_KEY_CODE = ['ArrowUp', 'KeyW'];
const MOVE_DOWN_KEY_CODE = ['ArrowDown', 'KeyS'];
const MOVE_LEFT_KEY_CODE = ['ArrowLeft', 'KeyA'];
const MOVE_RIGHT_KEY_CODE = ['ArrowRight', 'KeyD'];
const ALL_MOVE_KEY_CODES = [...MOVE_UP_KEY_CODE, ...MOVE_DOWN_KEY_CODE, ...MOVE_LEFT_KEY_CODE, ...MOVE_RIGHT_KEY_CODE];
...
export class Player {
  ...
  updatePosition() {
    if (this.shouldMove(MOVE_UP_KEY_CODE)) this.y -= this.velocity;
    if (this.shouldMove(MOVE_DOWN_KEY_CODE)) this.y += this.velocity;
    if (this.shouldMove(MOVE_LEFT_KEY_CODE)) this.x -= this.velocity;
    if (this.shouldMove(MOVE_RIGHT_KEY_CODE)) this.x += this.velocity;
  }
