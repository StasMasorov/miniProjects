...
function spawnEnemies() {
  countOfSpawnEnemies = 1;

  countIntervalId = setInterval(() => countOfSpawnEnemies++, 20000);
  spawnIntervalId = setInterval(() => spawnCountEnemies(countOfSpawnEnemies), 2000)
...
function animate() {
  ...
  context.clearRect(0, 0, canvas.width, canvas.height); //полностью очищет canvas перед каждой отрисовкой
